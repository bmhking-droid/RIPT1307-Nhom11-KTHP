...
${html}`;
  ...
  /**
   * Thu gui ma OTP dat lai mat khau
   */
  async sendPasswordResetOtpEmail(email, otp, expiresInMinutes = 10) {
    const subject = "Mã OTP đặt lại mật khẩu - UniAdmission";
    const html = `
      <div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 20px auto; padding: 30px; border: 1px solid #e5e7eb; border-radius: 16px; background-color: #ffffff;">
        <div style="text-align: center; border-bottom: 3px solid #2563eb; padding-bottom: 22px; margin-bottom: 24px;">
          <h2 style="color: #2563eb; margin: 0; font-size: 28px; font-weight: 800;">UniAdmission</h2>
          <p style="color: #4b5563; font-size: 14px; margin: 6px 0 0 0; font-weight: 500; text-transform: uppercase; letter-spacing: 1px;">Đặt lại mật khẩu</p>
        </div>

        <div style="color: #111827; line-height: 1.6; font-size: 15px;">
          <p>Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn.</p>
          <p>Vui lòng dùng mã OTP dưới đây để xác thực yêu cầu:</p>

          <div style="text-align: center; margin: 28px 0;">
            <div style="display: inline-block; padding: 14px 24px; border-radius: 12px; background-color: #eff6ff; border: 1px solid #bfdbfe; color: #1d4ed8; font-size: 32px; font-weight: 800; letter-spacing: 8px;">
              ${otp}
            </div>
          </div>

          <p style="color: #4b5563;">Mã này có hiệu lực trong <strong>${expiresInMinutes} phút</strong>. Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này.</p>
        </div>

        <div style="margin-top: 32px; border-top: 1px solid #edf2f7; padding-top: 18px; text-align: center; color: #9ca3af; font-size: 12px; line-height: 1.5;">
          <p style="margin: 0;">Đây là email tự động từ hệ thống UniAdmission. Vui lòng không phản hồi trực tiếp.</p>
        </div>
      </div>
    `;
  ...
  /**
   * Thu thong bao nop don thanh cong
   */
